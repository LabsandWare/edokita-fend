...
export class RegisterComponent implements OnInit {
  ...
  modes = [   
    ...
    constructor(private formBuilder: FormBuilder, private pharmacyService: PharmacyService, private router: Router) { }
    
    ngOnInit(): void {
      console.log(this.states)
      this.signupForm =this.formBuilder.group({
      pharmacyName: new FormControl(null, {validators: [Validators.required, Validators.minLength(3)]}),
      cPerson: new FormControl(null, {validators: [Validators.required, Validators.minLength(3)]}),
...
get f() { return this.signupForm.controls; }
  ...
  this.pharmacyService.signup(this.signupForm.value.pharmacyName, this.signupForm.value.cPerson, this.signupForm.value.email, this.signupForm.value.phone,
